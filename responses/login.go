...
func DefaultLoginBonus(base responseobjs.BaseInfo, player netobj.Player, doLoginBonus bool) LoginBonusResponse {
	lbs := obj.NewLoginBonusStatus(player.LoginBonusState.CurrentLoginBonusDay-1, player.LoginBonusState.CurrentLoginBonusDay-1, player.LoginBonusState.LastLoginBonusTime)
